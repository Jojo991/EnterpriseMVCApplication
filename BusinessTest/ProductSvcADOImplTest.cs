...
namespace BusinessTest
{
    ...
    public class ProductSvcADOImplTest
    {
        ...
        [TestMethod()]
        [HostType("ASP.NET")]
        [AspNetDevelopmentServerHost("C:\\GroceryApp\\GroceryApp", "/")]
        [UrlToTest("http://localhost:2163/")]
        public void AddProductTest()
        {
            ProductSvcADOImpl target = new ProductSvcADOImpl(); // TODO: Initialize to an appropriate value
        ...
        public void SearchProductTest()
        {
            ...
            Product actual;
            actual = target.SearchProduct(productCode);
