[T4Scaffolding.ViewScaffolder("Razor", Description = "Add an Ajax grid with many features (ordering, filtering etc...)", IsRazorType = $true, LayoutPageFilter = "*.cshtml,*.vbhtml|*.cshtml,*.vbhtml")][CmdletBinding()]
param(        
	...
	[parameter(Mandatory = $false, ValueFromPipelineByPropertyName = $true, Position = 2)][string]$ViewName = "Index",
	[string]$Template = "Obsidian.Views.GridTemplate",
	[string]$Area,
